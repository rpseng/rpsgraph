...
public DotLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("edge", this), new Integer(6));
	literals.put(new ANTLRHashString("node", this), new Integer(5));
...
tryAgain:
	...
	public final void mO_BRACE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
	...
	public final void mC_BRACE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = C_BRACE;
		int _saveIndex;
	...
	public final void mO_BRACKET(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = O_BRACKET;
		int _saveIndex;
	...
	public final void mC_BRACKET(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = C_BRACKET;
		int _saveIndex;
	...
	public final void mCONN(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = CONN;
		int _saveIndex;
